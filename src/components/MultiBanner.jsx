        ...
        <div className='bg-gray-100'>
            <div className='grid grid-cols-1 px-4 md:px-0 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 py-6 max-w-7xl mx-auto'>
                ...
                <div className='relative h-[250px]'>
                    ...
                    />
                    <div className='absolute inset-0 bg-[rgba(31,41,55,0.5)] rounded-lg bg-opacity-50 flex flex-col items-center justify-center'>
                ...
                <div className='relative h-[250px] col-span-1 sm:col-span-2'>
                    ...
                    className='w-full h-full object-cover rounded-lg shadow-lg' 
                    />
                    <div className='absolute inset-0 bg-[rgba(31,41,55,0.5)] bg-opacity-50 flex flex-col items-center rounded-lg justify-center'>
